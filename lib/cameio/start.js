...
CameioTask.prototype.fetchCameioStarter = function() {
  ...
  var repoName = 'cameio-starter-' + this.template;
...
CameioTask.prototype.fetchGithubStarter = function(repoUrl) {
  ...
  // https://github.com/videogamearmy/cameio-starter-tabs/
  ...
  if(!urlParse.hostname || urlParse.hostname.toLowerCase() !== 'github.com' || pathSplit.length !== 2) {
    ...
    console.log( ('Example of a valid URL: https://github.com/videogamearmy/cameio-starter-tabs/').error );
    self.cameio.fail('');
    q.reject();
    return q.promise;
  }
